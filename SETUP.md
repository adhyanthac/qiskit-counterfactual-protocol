...
- `counterfactual_results_v2.png` saved to current directory
- Additional parameter sweeps saved
...
2. Upload `counterfactual_simulation_v2.py`
3. Add at the top:
   ```python
...
```bash
chmod +x counterfactual_simulation_v2.py
```
...
3. Set an environment variable in PowerShell:
```powershell
...
- **Issues:** [GitHub Issues](https://github.com/adhyanthac/qiskit-counterfactual-protocol/issues)
- **Discussions:** [GitHub Discussions](https://github.com/adhyanthac/qiskit-counterfactual-protocol/discussions)
